...
SECRET_KEY = 'django-insecure-q39a^gup2p^zcmn6!oo!(a8x*vfeq_)9h1#8^s6_pc-f*ig&@y'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['app-advsoftware-6.devedu.io']

#Allows me to use django admin terminal.. don't know why I need it, but stackoverflow said so :(
#https://stackoverflow.com/questions/70285834/forbidden-403-csrf-verification-failed-request-aborted-reason-given-for-fail
CSRF_TRUSTED_ORIGINS = ['https://app-advsoftware-6.devedu.io']
